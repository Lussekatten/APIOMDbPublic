...
2. The second option, "Your favorites", lets you delete one movie or update the information about a particular movie. There is also a special button ("Clear the list") that deletes all the movies from the list.

3. You come to the page editMovie.html when you click the Edit button. 
You will be able to edit a movie and add relevant information, such as:
- movie genre
- actors
- a rating (4 or 5)
